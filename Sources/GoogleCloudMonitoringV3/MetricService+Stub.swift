  ...
  class MetricServiceTransport: MetricServiceStub {
    ...
    public func listMonitoredResourceDescriptors(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringV3.ListMonitoredResourceDescriptorsResponse.self, from: data)
    }
    ...
    public func listMetricDescriptors(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringV3.ListMetricDescriptorsResponse.self, from: data)
    }
    ...
    public func listTimeSeries(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringV3.ListTimeSeriesResponse.self, from: data)
    }
