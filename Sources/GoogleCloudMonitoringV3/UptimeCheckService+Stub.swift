  ...
  class UptimeCheckServiceTransport: UptimeCheckServiceStub {
    ...
    public func listUptimeCheckConfigs(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringV3.ListUptimeCheckConfigsResponse.self, from: data)
    }
    ...
    public func getUptimeCheckConfig(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringV3.UptimeCheckConfig.self, from: data)
    }
    ...
    public func listUptimeCheckIps(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudMonitoringV3.ListUptimeCheckIpsResponse.self, from: data)
    }
  }
}
