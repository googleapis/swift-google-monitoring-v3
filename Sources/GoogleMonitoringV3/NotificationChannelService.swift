...
public class NotificationChannelServiceClient: Clients.NotificationChannelServiceProtocol {
  ...
  public func listNotificationChannelDescriptors(
    ...
    let listRpc = {
      (token: Swift.String) async throws
        -> GoogleMonitoringV3.ListNotificationChannelDescriptorsResponse in
      var request = byItem
  ...
  public func listNotificationChannels(
    ...
    let listRpc = {
      (token: Swift.String) async throws -> GoogleMonitoringV3.ListNotificationChannelsResponse in
      var request = byItem
      request.pageToken = token
