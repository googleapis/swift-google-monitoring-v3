...
public class GroupServiceClient: Clients.GroupServiceProtocol {
  ...
  public func listGroups(
    ...
    let listRpc = { (token: Swift.String) async throws -> GoogleMonitoringV3.ListGroupsResponse in
      var request = byItem
  ...
  public func listGroupMembers(
    ...
    let listRpc = {
      (token: Swift.String) async throws -> GoogleMonitoringV3.ListGroupMembersResponse in
      var request = byItem
      request.pageToken = token
...
extension Clients {
  ...
  public protocol GroupServiceProtocol {
    ...
    func getGroup(request: GetGroupRequest) async throws -> GoogleMonitoringV3.Group
    ...
    func createGroup(request: CreateGroupRequest) async throws -> GoogleMonitoringV3.Group
    ...
    func updateGroup(request: UpdateGroupRequest) async throws -> GoogleMonitoringV3.Group
...
extension Clients.GroupServiceProtocol {
  ...
  public func getGroup(request: GetGroupRequest) async throws -> GoogleMonitoringV3.Group {
  ...
  public func createGroup(request: CreateGroupRequest) async throws -> GoogleMonitoringV3.Group {
  ...
  public func updateGroup(request: UpdateGroupRequest) async throws -> GoogleMonitoringV3.Group {
