  ...
  class NotificationChannelServiceTransport: NotificationChannelServiceStub {
    ...
    public func listNotificationChannelDescriptors(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleMonitoringV3.ListNotificationChannelDescriptorsResponse.self, from: data)
    }
    ...
    public func getNotificationChannelDescriptor(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleMonitoringV3.NotificationChannelDescriptor.self, from: data)
    }
    ...
    public func listNotificationChannels(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleMonitoringV3.ListNotificationChannelsResponse.self, from: data)
    }
    ...
    public func getNotificationChannel(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleMonitoringV3.NotificationChannel.self, from: data)
    }
    ...
    public func getNotificationChannelVerificationCode(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleMonitoringV3.GetNotificationChannelVerificationCodeResponse.self, from: data)
    }
