...
public class SnoozeServiceClient: Clients.SnoozeServiceProtocol {
  ...
  ) async throws -> GoogleMonitoringV3.Snooze {
  ...
  ) async throws -> GoogleMonitoringV3.ListSnoozesResponse {
  ...
  public func listSnoozes(
    ...
    let listRpc = { (token: Swift.String) async throws -> GoogleMonitoringV3.ListSnoozesResponse in
      var request = byItem
...
extension Clients {
  ...
  public protocol SnoozeServiceProtocol {
    ...
    func createSnooze(request: CreateSnoozeRequest) async throws -> GoogleMonitoringV3.Snooze
    ...
    func listSnoozes(request: ListSnoozesRequest) async throws
      -> GoogleMonitoringV3.ListSnoozesResponse
    ...
    func getSnooze(request: GetSnoozeRequest) async throws -> GoogleMonitoringV3.Snooze
    ...
    func updateSnooze(request: UpdateSnoozeRequest) async throws -> GoogleMonitoringV3.Snooze
...
extension Clients.SnoozeServiceProtocol {
  public func createSnooze(request: CreateSnoozeRequest) async throws -> GoogleMonitoringV3.Snooze {
  ...
  public func getSnooze(request: GetSnoozeRequest) async throws -> GoogleMonitoringV3.Snooze {
  ...
  public func updateSnooze(request: UpdateSnoozeRequest) async throws -> GoogleMonitoringV3.Snooze {
